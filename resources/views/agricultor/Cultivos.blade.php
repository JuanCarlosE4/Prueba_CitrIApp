...
{{-- Botón para ir al ver los cultivos --}}
...
{{-- Botón para ir a registrar una finca --}}
                ...
                <article class="tablaCS">
                    <section class="hijotabla_CS list-inline">
                        ...
                        <section class="contenedorbtncs">
                            ...
                            <li class="btn_CS"><input class="botonsCSborrar" type="image" src="Img/btnborrar.png" value=""></li>
                        </section>
                    </section>
                </article>
            </section>
